...
function makeDesign(overrides: Partial<SavedDesign> = {}): SavedDesign {
  return {
    ...
    zones: {
      "zone-1": {
        names: "Amelia & Ravi",
        namesStyle: { color: "#1a1a1a", letterSpacing: 0, lineSpacing: 0, curve: 0, align: "center" },
        textFont: "greatvibes",
        date: "2026-06-14",
        dateStyle: { color: "#1a1a1a", letterSpacing: 0, lineSpacing: 0, curve: 0, align: "center" },
        monogram: "heart",
        ...
        elemScale: { names: 1, date: 1, monogram: 1, frame: 1, logo: 1, qr: 1 },
        elemRotationOffset: { names: 0, date: 0, monogram: 0, frame: 0, logo: 0, qr: 0 },
